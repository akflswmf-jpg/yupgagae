      ...
      MaterialPageRoute(
        builder: (_) => NicknameEditScreen(
          ...
          onSave: (nickname) async {
            await c.changeNickname(nickname);
          },
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: MyStoreBody(
          controller: c,
          onShowNicknameSheet: (profile) =>
              _showNicknameSheet(context, c, profile),
          onShowRegionSheet: (profile) =>
              _showRegionSheet(context, c, profile),
          onShowIndustrySheet: (profile) =>
              _showIndustrySheet(context, c, profile),
