...
class CommunityCommentCard extends StatelessWidget {
  ...
  final String reportBlindedText;
  final String adminHiddenText;
  ...
  const CommunityCommentCard({
    ...
    required this.reportBlindedText,
    required this.adminHiddenText,
  ...
  Widget build(BuildContext context) {
    ...
    final isMine =
        normalizedUserId.isNotEmpty && comment.authorId == normalizedUserId;
    final isReply = depth > 0;
    final isBlocked = comment.isDeleted || comment.isHiddenFromPublic;
    final isLikedByMe = normalizedUserId.isNotEmpty &&
        comment.likedUserIds.contains(normalizedUserId);
    final likeColor = isLikedByMe ? kCommentLikeActive : kCommentLikeInactive;
          ...
          if (bodyLeftInset > 0)
            Padding(
              ...
              child: _CommentBody(
                ...
                reportBlindedText: reportBlindedText,
                adminHiddenText: adminHiddenText,
                textStyle: textStyle,
...
class _CommentActionRow extends StatelessWidget {
  ...
  Future<void> _runAfterSheetClosed(
