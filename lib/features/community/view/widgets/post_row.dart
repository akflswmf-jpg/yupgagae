...
class PostRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rawThumbPath =
        post.imagePaths.isNotEmpty ? post.imagePaths.first.trim() : null;
...
class _PostMainBlock extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final safeThumbPath = thumbPath?.trim();
    ...
    return ConstrainedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          if (safeThumbPath != null && safeThumbPath.isNotEmpty) ...[
            const SizedBox(width: 12),
            _Thumb(path: safeThumbPath),
          ],
        ],
      ),
    );
