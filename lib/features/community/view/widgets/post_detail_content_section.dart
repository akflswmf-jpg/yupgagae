// lib/features/community/view/widgets/post_detail_content_section.dart
  ...
  Future<void> _precachePostImages() async {
    ...
    for (var i = 0; i < paths.length; i++) {
      ...
      try {
        ...
        // 프리캐시 실패는 렌더 단계 errorBuilder에서 처리한다.
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: List.generate(paths.length, (i) {
        return Padding(
          padding: EdgeInsets.only(bottom: i == paths.length - 1 ? 0 : 12),
