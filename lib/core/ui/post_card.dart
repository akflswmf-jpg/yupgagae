...
class PostCard extends StatelessWidget {
  ...
  const PostCard({
    ...
    this.imageCount,
    this.imagePaths,
    this.obscureMedia = false,
  });

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final thumbPath = !obscureMedia &&
            imagePaths != null &&
          ...
          children: [
            ...
            if (_hasMeta) ...[
              ...
              _MetaRow(
                ...
                viewCount: viewCount,
                imageCount: obscureMedia ? 0 : imageCount,
              ),
            ],
            const SizedBox(height: AppSpace.xs),
            Row(
  ...
  bool get _hasMeta {
    ...
    final hasImages = !obscureMedia && imageCount != null && imageCount! > 0;
